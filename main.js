...
function bedroom()
{
    window.location = "/Object-Detection/test1.html"
}
function tv()
{
    window.location = "/Object-Detection/test2.html"
}
function desk()
{
    window.location = "/Object-Detection/test3.html"
}
function bottles()
{
    window.location = "/Object-Detection/test4.html"
}
function fruitbasket()
{
    window.location = "/Object-Detection/test5.html"
}
img = ""
function preload()
{
...
function setup()
{
    if(window.location.pathname == "/Object-Detection/test1.html")
    {
        canvas = createCanvas(480, 404)
    }
    else if(window.location.pathname == "/Object-Detection/test2.html")
    {
        canvas = createCanvas(850, 567)
    }
    else if(window.location.pathname == "/Object-Detection/test3.html")
    {
        canvas = createCanvas(400, 400)
    }
    else if(window.location.pathname == "/Object-Detection/test4.html")
    {
        canvas = createCanvas(1024, 512)
    }
    else if(window.location.pathname == "/Object-Detection/test5.html")
    {
